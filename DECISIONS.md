...
2026-08-19 | Fixed 7 findings from a full technical audit before any pilot pitch: site-chat now writes leads, contact.html now has a working form, portal-intake rate limited, compliance guard consolidated to one shared file, retainer-export webhook SSRF-guarded, PDF generation crash-safe for non-Latin names, rate_limits_prune scheduled. | An independent audit found the marketing site's own lead capture was fully disconnected, a real prospect could chat and leave contact info with nothing recorded. This was a bigger risk to the pitch than pricing or competition. | None.
