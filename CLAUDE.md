...
8. ROADMAP (in rough order): daily-briefing 8am cron, IRCC change monitoring feeding the briefing, retainer export handoff, e-signatures for retainers, consultation payments, multi-staff roles, SMS notifications, SOC 2 style security posture document, client password reset flow.
